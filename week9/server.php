...
$iCon = $iConn = mysqli_connect(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME) or die(myError(__FILE__,__LINE__,mysqli_connect_error()));
...
$user_check_query = "SELECT * FROM users WERE username = '$username' OR email
= '$email' LIMIT 1 ";
