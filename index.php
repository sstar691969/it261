...
<div id="hero">
    ...
    <a href="index.html">
        ...
        <img id="Mamp-screenshot" src="images/me.jpg" alt="mamp photo"/>
        
        
        </a>
        
<!-----scr image could go here-->
</div>
<!-- end hero -->

<main>
<h1>William Anderson's Portal Page</h1>

<p>Hello, Im William and I love traveling and walking along Seward park and Alki. My goal is to complete my web development certificate by 2023.
...
<aside>
<h3>My Class Assignments: Week 2 thru Week 8</h3>
...
<!--mamp screen & error_php screenshot goes here-->

<p>mamp screenshot</p>
    <a href="index.html">

    <img id="Mamp-screenshot" src="images/mamp-screenshot.jpeg" alt="mamp photo"/>
    
    
    </a>
    
<p>error php screenshot</p>
    <a href="index.html">

        <img id="error-php-screenshot" src="images/error_php.jpeg" alt="error photo"/>
...
<footer>
    <ul>
        ...
        <li><a href="../index.php">Web Design by William L Anderson</a></li>
