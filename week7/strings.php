...
echo "<h2>Now, I would like to display just the worth - I am reading</h2>";
echo '<br>';
...
$statement2 = 'Hulu\'s redition of the Looming Tower is based on the bank named the Looming Tower! ';
